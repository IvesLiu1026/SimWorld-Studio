...
Only ordinary phase requests are supported.  Recovery/control requests need a
separate durable control ledger and therefore fail closed here instead of
being routed through the phase ledger.
"""
