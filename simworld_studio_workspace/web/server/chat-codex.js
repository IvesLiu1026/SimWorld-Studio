  ...
  try {
    ...
    if (!deps.MOCK_MODE && sceneIR.resolveIRMode(body) === "on") {
      ...
      irPromptBlock = await sceneIR.buildIRBlock(message, {
        ...
        irSolver: body.irSolver, irRepair: body.irRepair, irCot: body.irCot, irAscii: body.irAscii, irRichAssets: body.irRichAssets, irPlanCritic: body.irPlanCritic, irGroundPass: body.irGroundPass, irMotifs: body.irMotifs,
